<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <p class="text-muted page-title-alt">All Use Posts!</p>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="card-box table-responsive">
            <h4 class="m-t-0 header-title"><b>All Posts</b></h4>
                    ...
                    <div class="col-sm-12">
                        ...
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting_asc" tabindex="0" aria-controls="datatable-fixed-header" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Name: activate to sort column descending" style="width: 160px; min-width: 160px;">Title</th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-fixed-header" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="width: 264px; min-width: 264px;">Date</th>
                                <th class="sorting" tabindex="0" aria-controls="datatable-fixed-header" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="width: 116px; min-width: 116px;">Posted By</th>
